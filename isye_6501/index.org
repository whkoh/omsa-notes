...
Combines both, i.e.
$S-t = \alpha x_t + (1-\alpha)S_{t-1}$
- 0 < \alpha <1
  - \alpha \rightarrow 0: much chaotic randomness
    - trust yesterday's baseline more
  - \alpha \rightarrow 1: order in the system
    - trust today's reading more

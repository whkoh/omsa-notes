...
- Start with no factors, then add
  [[/Users/whkoh/git-repos/omsa-notes/isye_6501/img/m11-fwd-sel.png]]
*** Backward elimination
- Start with all factors, then eliminate
  [[/Users/whkoh/git-repos/omsa-notes/isye_6501/img/m11-backw-elim.png]]
*** Stepwise regression
- Combines forward selection and backward elimination
  [[/Users/whkoh/git-repos/omsa-notes/isye_6501/img/m11-stepwise.png]]
*** Types of approaches
- Greedy
...
*** Coefficients -> magnitude of effect
...
*** Ridge regression limits the magnitude of the regression coefficient instead of the number of variables
...
- If arrivals are Poisson(\lambda):
  - Time between successive arrivals is distributed by exponential(\lambda) distribution
...
- Objective function :: measure of quality of solution
- Solution :: value for each variable
- Feasible solution :: variable value that satisfy all constraints
...
- If/then constraints
** M15L05: Discovering the real questions
*** Real life
...
**** Summary
- McNemar's (Binomial) test: Only consider when A and B are different.
...
3. After k iterations,
   ...
   \gamma_k H_k(x)
   $$
4. *Boosting* = adding the models together (F and H)

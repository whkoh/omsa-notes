...
1. These are observations with predictor value outside normal range of observations
2. Point has high leverage if its deletion (by itself or with 2-3 other points) causes noticable changes in the model
